...
public class Contact_Obtain {

    private AppCompatActivity activity;

    public Contact_Obtain(AppCompatActivity activity) {
...
//            String last_name = phones.getString(phones.getColumnIndex(ContactsContract.CommonDataKinds.StructuredName.FAMILY_NAME));
            ...
            contactlist.add(new Contact(id,names , emails, numbers, addresses, fav,getBirthday(id),nav));
